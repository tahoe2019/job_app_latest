...
export async function ImagesCard() {
  ...
  return (
    <div className="items-center justify-center flex">
      <Card className="max-w-6xl mt-10 ml-10 p-2 mr-10 ">
      <h5 className="mb-2 text-3xl font-bold text-gray-900 dark:text-white"> Willkommen  
       <span className="text-blue-600"> {session?.user.name}</span>  wir hoffen, es geht Ihnen gut
        </h5>
